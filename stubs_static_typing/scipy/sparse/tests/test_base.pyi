...
from scipy.sparse import SparseEfficiencyWarning as SparseEfficiencyWarning, bsr_matrix as bsr_matrix, coo_matrix as coo_matrix, csc_matrix as csc_matrix, csr_matrix as csr_matrix, dia_matrix as dia_matrix, dok_matrix as dok_matrix, eye as eye, isspmatrix as isspmatrix, lil_matrix as lil_matrix
from scipy.sparse.linalg import expm as expm, inv as inv, splu as splu
from scipy.sparse.sputils import asmatrix as asmatrix, get_index_dtype as get_index_dtype, isscalarlike as isscalarlike, matrix as matrix, supported_dtypes as supported_dtypes
from typing import Any

__usage__: str
IS_COLAB: Any

def assert_in(member, collection, msg: Any | None = ...) -> None: ...
def assert_array_equal_dtype(x, y, **kwargs) -> None: ...

NON_ARRAY_BACKED_FORMATS: Any

def sparse_may_share_memory(A, B): ...

sup_complex: Any

def with_64bit_maxval_limit(maxval_limit: Any | None = ..., random: bool = ..., fixed_dtype: Any | None = ..., downcast_maxval: Any | None = ..., assert_32bit: bool = ...): ...
def todense(a): ...
...
class _TestSlicingAssign:
    ...
    def test_assign_empty_spmatrix(self) -> None: ...
...
class _NonCanonicalMixin:
    def spmatrix(self, D, sorted_indices: bool = ..., **kwargs): ...
    def test_bool(self) -> None: ...
    def test_getnnz_axis(self) -> None: ...
    def test_empty(self) -> None: ...
...
def cases_64bit() -> Generator[Any, None, None]: ...
